...
const IMAGE_FIELDS = [
  {
    key: 'site.faviconUrl',
    label: '파비콘',
    hint: '브라우저 탭과 즐겨찾기 아이콘. 정사각형 512×512 PNG 를 권합니다 (iOS 홈 화면은 SVG 를 쓰지 않습니다). 비우면 기본 아이콘을 씁니다.',
    preview: 'square',
  },
  {
    key: 'site.ogImageUrl',
    label: '공유 카드 기본 이미지',
    hint: '카카오톡·슬랙·X 등에 링크를 붙였을 때 나오는 이미지. 1200×630 을 권합니다. 글에 자체 이미지가 있으면 그쪽이, 여기가 비면 기본 카드가 쓰입니다.',
    preview: 'wide',
  },
] as const;
